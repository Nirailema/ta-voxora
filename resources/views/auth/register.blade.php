    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-text-primary mt-6">Buat Akun Baru</h1>
                <p class="text-text-secondary mt-2">Bergabunglah dengan VOXARA</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5" novalidate>
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-semibold text-text-primary mb-2">Konfirmasi Kata Sandi</label>
            ...
            <p class="text-center text-sm text-text-secondary mt-6">
                Sudah punya akun? <a href="{{ route('login') }}" class="text-secondary font-semibold hover:underline focus:outline-none focus:ring-2 focus:ring-secondary/50 rounded">Masuk di sini</a>
            </p>
        </div>
    </div>
</main>
